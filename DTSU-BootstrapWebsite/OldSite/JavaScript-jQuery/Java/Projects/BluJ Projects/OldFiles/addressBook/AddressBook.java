    	 ...
    	 public void actionPerformed(ActionEvent ae)
    	    {
    	        if(ae.getActionCommand() == "Add New Contact")
    	            ...
    	            {
    	                  JOptionPane.showMessageDialog(frame, "About AddressBook: Created By Danny Anner Website: http://www.hdanstechsupport.comuv.com","About Address Book",JOptionPane.INFORMATION_MESSAGE);
