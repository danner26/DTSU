    ...
    Rating.prototype = {
        ...
        listen: function () {
            ...
            self.$clear.on("mousemove", function () {
                ...
                var caption = '<span id="rating-words" class="' + self.clearCaptionClass + '">' + self.clearCaption + '</span>',
        ...
        fetchCaption: function (rating) {
            ...
            return '<span id="rating-words" class="' + css + '">' + caption + '</span>';
        },
        ...
        clear: function () {
            var self = this,
                title = '<span id="rating-words" class="' + self.clearCaptionClass + '">' + self.clearCaption + '</span>';
